...
export function RetroGrid({ className, angle = 65 }) {
  return (
    <div
      className={cn(
        "pointer-events-none absolute inset-0 -top-[200px] overflow-hidden [perspective:200px]",
        className
      )}
    ...
    >
      ...
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-linear-to-t from-black to-transparent to-50%" />
    </div>
  );
}
